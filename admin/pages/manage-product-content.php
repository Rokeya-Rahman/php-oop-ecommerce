...
<!--                            <td>--><?php //print htmlentities($product['product_long_description']); ?><!--</td>-->
                            ...
                            <td class="center">
                                ...
                                <a class="btn btn-danger" href="?p_status=delete&product_id=<?php print $product['product_id']; ?>" onclick="return confirm('Are you sure to delete this category information !!!')">
